...
class DailyCron extends Command
{
    ...
    public function handle()
    {
        ...
        $propertiesalerts = savedPropertyAlert::where('type','1')->where('search_type','1')->get();
        ...
        $propertiesalerts = savedPropertyAlert::where('type','1')->where('search_type','2')->get();
            ...
            if(($properties_ids == '0') || !($ids === array_intersect($ids, $properties_ids) && $properties_ids === array_intersect($properties_ids, $ids)))
            {
                ...
                Mail::send('emails.propertiesAlert',
                    array(
                        ...
                        $message->from(getcong('site_email'),getcong('site_name'));
                        $message->to($sender_email)
                            ->subject('Daily New Construction Properties Alert based on your saved search by ' . getcong('site_name'));
                    });
            }
