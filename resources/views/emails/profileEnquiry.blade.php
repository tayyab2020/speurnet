            ...
            <td bgcolor="#ffffff" style="padding:40px 30px 40px 30px">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr><td>Hi <span style="text-decoration: underline;">Mr/Mrs {{$parameters->agent_name}}</span>, An enquiry has been posted by <span style="text-decoration: underline;">Mr/Mrs {{$parameters->first_name}} {{$parameters->last_name}}</span> on your profile at {{getcong('site_name')}}</td></tr>
                        ...
                        <tr><td style="padding:10px 0 0 0">
                                ...
                                <table cellpadding="0px" cellspacing="0px">
                                    ...
                                    <tr><td style="padding:15px 0 0 0">
                                            <img src="{{ $message->embed(public_path() . '/assets/img/email.png') }}" style="width: 13px;margin-right: 8px;display: block;float: left;margin-top: 2px;"><b style="color: black;">Message: </b><span style="color: #7474d3;font-weight: 700;">"{!! $parameters->message !!}"</span>
                                        </td></tr>

                                    <tr><td style="padding:15px 0 0 0">
                                            <img src="{{ $message->embed(public_path() . '/assets/img/signs.png') }}" style="width: 13px;margin-right: 8px;display: block;float: left;margin-top: 2px;"><b style="color: black;">Email Address: </b><span style="color: #7474d3;font-weight: 700;">{{$parameters->email}}</span>
                                        </td></tr>

                                    @if($parameters->phone)

                                        <tr><td style="padding:15px 0 0 0">
                                                <img src="{{ $message->embed(public_path() . '/assets/img/communications.png') }}" style="width: 15px;margin-right: 6px;display: block;float: left;"><b style="color: black;">Phone: </b><span style="color: #7474d3;font-weight: 700;">{{$parameters->phone}}</span>
                                            </td></tr>
                                    ...
                                    @if($parameters->postcode)
                                        ...
                                        <tr><td style="padding:15px 0 0 0">
                                                <img src="{{ $message->embed(public_path() . '/assets/img/pin.png') }}" style="width: 15px;margin-right: 6px;display: block;float: left;"><b style="color: black;">Postcode: </b><span style="color: #7474d3;font-weight: 700;">{{$parameters->postcode}}</span>
                                            </td></tr>
