            ...
            <tr>
                <td bgcolor="#ffffff" style="padding:40px 30px 40px 30px">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr><td>Beste {{$parameters->first_name}} {{$parameters->last_name}},</td></tr>
                        <tr><td>{{$parameters->agent_name}} is op de hoogte gebracht van jouw verzoek en zal binnenkort contact met je opnemen.</td></tr>
                        ...
                        <tr><td style="padding:10px 0 0 0">
                                ...
                                <table cellpadding="0px" cellspacing="0px">
                                    ...
                                    <tr><td style="padding:15px 0 0 0">
                                            <img src="{{ $message->embed(public_path() . '/assets/img/signs.png') }}" style="width: 13px;margin-right: 8px;display: block;float: left;margin-top: 2px;"><b style="color: black;">Makelaar E-mailadres: </b><span style="color: #7474d3;font-weight: 700;">{{$parameters->email}}</span>
                                        </td></tr>
