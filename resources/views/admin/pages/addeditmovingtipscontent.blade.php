...
@section("content")
    ...
    <div id="main">
        <div class="page-header">
            <h2> {{ isset($slide->name) ? 'Edit Content: '. $slide->name : 'Add Content' }}</h2>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                {!! Form::open(array('url' => array('admin/moving-tips/addmovingtipscontent'),'class'=>'form-horizontal padding-15','name'=>'user_form','id'=>'user_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
