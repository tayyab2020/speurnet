...
@section("content")
    ...
    <div id="main">
        <div class="page-header">
            ...
            <a href="{{ URL::to('admin/vactury-provinces') }}" class="btn btn-default-light btn-xs"><i class="md md-backspace"></i> Back</a>
        ...
        <div class="panel panel-default">
            ...
            {!! Form::open(array('url' => array('admin/vactury-provinces/addvacturyprovince'),'class'=>'form-horizontal padding-15','name'=>'user_form','id'=>'user_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
