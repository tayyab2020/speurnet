...
@section("content")
    ...
    <div id="main">
        ...
        <div class="panel panel-default">
            ...
            {!! Form::open(array('url' => array('admin/place-to-be-content/add'),'class'=>'form-horizontal padding-15','name'=>'user_form','id'=>'user_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
