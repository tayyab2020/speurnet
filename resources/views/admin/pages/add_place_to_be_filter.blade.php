...
@section("content")
    ...
    <div id="main">
        <div class="page-header">
            ...
            <a href="{{ URL::to('admin/place-to-be-filters') }}" class="btn btn-default-light btn-xs"><i class="md md-backspace"></i> Back</a>
        ...
        <div class="panel panel-default">
            ...
            {!! Form::open(array('url' => array('admin/place-to-be-filters/addfilter'),'class'=>'form-horizontal padding-15','name'=>'user_form','id'=>'user_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
                ...
                <div class="form-group">
                    <label style="font-size: 20px;" for="avatar" class="col-sm-3 control-label">Image</label>
                    <div class="col-sm-9">
                        <div class="media">
