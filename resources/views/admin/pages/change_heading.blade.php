...
@section("content")
    ...
    <div id="main">
        <div class="page-header">
            <h2>Change Heading for While you are here page</h2>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                {!! Form::open(array('url' => array('admin/homepage-icons/changeheading'),'class'=>'form-horizontal padding-15','name'=>'user_form','id'=>'user_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
