        ...
        <div role="tabpanel">
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation">
                    <a href="#social_links" aria-controls="social_links" role="tab" data-toggle="tab">Social
                        Settings</a>
                </li>
                <li role="presentation">
                    <a href="#share_comments" aria-controls="share_comments" role="tab" data-toggle="tab">Disqus
                        Comment</a>
                </li>
                <li role="presentation">
                ...
                <li role="presentation">
                    <a href="#privacy_policy" aria-controls="privacy_policy" role="tab" data-toggle="tab">Privacy
                        Policy</a>
                </li>

                <li role="presentation">
                    <a href="#other_Settings" aria-controls="other_Settings" role="tab" data-toggle="tab">Other
                        Settings</a>
                </li>
                </li>
            </ul>
            ...
            <div class="tab-content tab-content-default">
                <div role="tabpanel" class="tab-pane active" id="account">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <select id="basic" name="site_style" class="selectpicker show-tick form-control">
                                ...
                                <option value="orange" @if($settings->site_style=='orange')selected @endif >Orange
                                </option>

                                <option value="red" @if($settings->site_style=='red')selected @endif >Red</option>
                                <option value="yellow" @if($settings->site_style=='yellow')selected @endif >Yellow
                                </option>
                    ...
                    <div class="form-group">
                        <label for="" class="col-sm-3 control-label">Property Page Button URL</label>
                        <div class="col-sm-9">
                            <input type="text" name="button_url" value="{{ $settings->button_url }}"
                                   class="form-control" value="">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea type="text" name="site_keywords" class="form-control" rows="5"
                                      placeholder="A few words about site">{{ $settings->site_keywords }}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea type="text" name="footer_widget1" class="form-control" rows="5"
                                      placeholder="A few words about site">{{ $settings->footer_widget1 }}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea type="text" name="footer_widget2" class="form-control" rows="5"
                                      placeholder="A few words about site">{{ $settings->footer_widget2 }}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea type="text" name="footer_widget3" class="form-control" rows="5"
                                      placeholder="A few words about site">{{ $settings->footer_widget3 }}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="" class="col-sm-3 control-label">Copyright Text</label>
                        <div class="col-sm-9">
                            <textarea type="text" name="site_copyright" class="form-control"
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-3 col-sm-9 ">
                            <button type="submit" class="btn btn-primary">Save Changes <i class="md md-lock-open"></i>
                            </button>
                ...
                <div role="tabpanel" class="tab-pane" id="social_links">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="social_gplus" value="{{ $settings->social_gplus }}"
                                   class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="social_insta" value="{{ $settings->social_insta }}"
                                   class="form-control">
                        </div>
                    </div>
                ...
                <div role="tabpanel" class="tab-pane" id="about_us">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="about_us_title" value="{{ $settings->about_us_title }}"
                                   class="form-control" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea type="text" name="about_us_description" class="form-control summernote"
                                      rows="5">{{ $settings->about_us_description }}</textarea>
                        </div>
                    </div>
                ...
                <div role="tabpanel" class="tab-pane" id="careers_with_us">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="careers_with_us_title"
                                   value="{{ $settings->careers_with_us_title }}" class="form-control" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="" class="col-sm-3 control-label">Description</label>
                        <div class="col-sm-9">
                            <textarea type="text" name="careers_with_us_description" class="form-control summernote"
                                      rows="5">{{ $settings->careers_with_us_description }}</textarea>
                        </div>
                    </div>
                ...
                <div role="tabpanel" class="tab-pane" id="terms_conditions">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="terms_conditions_title"
                                   value="{{ $settings->terms_conditions_title }}" class="form-control" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="" class="col-sm-3 control-label">Description</label>
                        <div class="col-sm-9">
                            <textarea type="text" name="terms_conditions_description" class="form-control summernote"
                                      rows="5">{{ $settings->terms_conditions_description }}</textarea>
                        </div>
                    </div>
                ...
                <div role="tabpanel" class="tab-pane" id="privacy_policy">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="privacy_policy_title" value="{{ $settings->privacy_policy_title }}"
                                   class="form-control" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="" class="col-sm-3 control-label">Description</label>
                        <div class="col-sm-9">
                            <textarea type="text" name="privacy_policy_description" class="form-control summernote"
                                      rows="5">{{ $settings->privacy_policy_description }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea type="text" name="site_header_code" class="form-control" rows="5"
                                      placeholder="You may want to add some html/css/js code to header. ">{{ $settings->site_header_code }}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea type="text" name="site_footer_code" class="form-control" rows="5"
                                      placeholder="You may want to add some html/css/js code to footer. ">{{ $settings->site_footer_code }}</textarea>
                        </div>
                    </div>
