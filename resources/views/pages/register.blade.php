...
@section('head_title', isset($page_content->meta_title) ? $page_content->meta_title : 'Accountaanmaken | '.getcong('site_name'))
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div style="margin-top: 25px;margin-bottom: 10px;">
                                    ...
                                    <a target="_blank" href="{{ url('nl/Voor makelaars ( CRM-systeem )') }}" class="btn btn-danger">Ik ben benieuwd</a>
