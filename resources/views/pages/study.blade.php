    ...
    <div id="content" style="padding: 30px 0 20px 0;">
        ...
        <div class="container" style="width: 100%;">
            ...
            <div class="row" style="margin: 0;">
                ...
                <div style="padding: 0;" class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    ...
                    <div class="row company-boxes">
                        ...
                        @php
                            ...
                            $backgrounds = array("background-color: #F5DEF3;color: #94328b;","background-color: #C2EEEB;color: #36a49c;","background-color: #DAF4D9;color: #3cc736;","background-color: #F4E4BD;color: #917633;","background-color: #F7D5D9;color: #8d434c;","background-color: #D9CEF8;color: #4b3684;");
                ...
                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                    ...
                    <h3 style="font-weight: 600;text-align: left;margin: 0;">Testimonials</h3>

                    <div style="margin: 20px 0 0 0;" class="row">

                        <div style="margin: 15px 0 0 0;display: flex;align-items: flex-start;flex-direction: column;padding: 20px 10px;border-radius: 10px;border: 1px solid #dadada;" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">

                            <div style="margin: 0;display: flex;flex-direction: row;justify-content: flex-start;" class="row">

                                <div>
                                    <img style="width: 35px;height: 35px;border-radius: 100%;" src="{{asset('assets/img/logos.png')}}" />
                                </div>

                                <div style="display: flex;flex-direction: column;margin-left: 10px;">
                                    <h6 style="margin: 0;">ABC</h6>
                                    <span style="font-size: 12px;">7 months ago</span>
                                </div>
                            ...
                            <div style="margin: 20px 0 0 0;" class="row">
                                ...
                                <p>This service was the biggest help during finals. I was overwhelmed and physically exhausted with urgent assignements.</p>
