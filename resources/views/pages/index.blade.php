                        ...
                        <div class="col-md-3 col-sm-12 col-xs-12 flex-box-div">
                            <div class="property-container" style="margin: 10px auto;min-height: 433px;">
                                ...
                                <div class="property-content description-content">
                                    ...
                                    <p style="text-overflow: ellipsis;display: block;white-space: nowrap;width: 100%;-webkit-line-clamp: 2;-webkit-box-orient: vertical;overflow: hidden;line-height: 2;font-size: 15px;margin-top: 15px;">{{$description}}</p>
