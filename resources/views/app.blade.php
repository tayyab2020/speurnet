...
<head>
  ...
  @if(Route::currentRouteName() != 'zoekhet' && Route::currentRouteName() != 'page1' && Route::currentRouteName() != 'company' && Route::currentRouteName() != 'blogs' && Route::currentRouteName() != 'education' && Route::currentRouteName() != 'education-single')
